...
With that, I can narrow my focus onto the data from Alberta in recent years. Looking at education next, I notice a curious finding.

![boxplot of wage and education](wage_educ.png)

The mean of people with some post secondary education is higher than those with a Bacherlors or higher. Those with a Bacherlors has a higher wage ceiling but the finding is still surprising.
...
The other 3 provinces do not have this anomaly. Their mean for those with a Bachelors is quite a bit higher than those with some post-secondary education.

I fit a linear regression line to see the effect of these two education levels on wage over the course of the 17 years.
...
There does not seem to be a significant difference on the effect on wage between the two education levels throughout the years. This leads me to include both of these education levels on my analysis below.
...
Women have a smaller variance than men, but we can see men on average have a higher wage.

Looking at age:

![boxplot of wage and age](wage_age.png)

The first two age groups 15-29 and 30-44 make more on average than the other two groups. It is a bit interesting to see that those in the 15-29 group can make as much if not more than those 30-44.

So overall, it seems men working in Alberta of the age 15-44 with some post secondary education or more and not in a union make the highest wage. Thinking about this intuitively, the results aren't too surprising if we think about the oil industry in Alberta. The industry is more likely to attract younger males who haven't settled down yet to work at more isolated environments with a reward of high pay.
